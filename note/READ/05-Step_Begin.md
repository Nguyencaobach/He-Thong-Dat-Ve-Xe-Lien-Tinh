...
## 🚀 Tóm tắt lệnh nhanh — Fresh Start (Backend)
...
Đối với thư mục `frontend` (giao diện web):
...
| **Cam** | **`frontend` (Next.js)** | **3000** | **Giao diện Người dùng/Admin** |

> **GraphQL Sandbox:** Truy cập `http://localhost:4000/graphql` sau khi chạy backend.
