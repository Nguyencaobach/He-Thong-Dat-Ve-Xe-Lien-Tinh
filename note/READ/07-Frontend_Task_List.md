...
- [x] **Tìm kiếm Chuyến xe (`(public)/trips`)**:
  ...
  - [ ] **Gợi ý ngày lân cận**: Khi không tìm thấy chuyến xe trong ngày yêu cầu, tự động gọi API kiểm tra số lượng vé của các ngày lân cận (hôm qua, ngày mai) để hiển thị gợi ý.
